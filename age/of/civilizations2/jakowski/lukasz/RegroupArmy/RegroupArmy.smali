...
.method public static canBeUsedInPath(IIZI)Z
    ...
    invoke-virtual {v0, p0, v2}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->getMilitaryAccess(II)I
    ...
    invoke-virtual {v0, p0, v2}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->getCivRelationOfCivB(II)F
...
.method public static final isFriendlyProvince(II)Z
    ...
    invoke-virtual {v0, p0, v1}, Lage/of/civilizations2/jakowski/lukasz/Core/Core;->getMilitaryAccess(II)I
...
.method public buildPath(ILjava/util/List;Ljava/util/List;Ljava/util/List;II)Z
    ...
    invoke-virtual {v8, v13, v14, v1, v14}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->setPath(IILjava/util/List;I)V

    .line 284
    invoke-virtual {v8, v10}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->clearWas(Ljava/util/List;)V
    ...
    invoke-static {v9, v14}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->isFriendlyProvince(II)Z

    move-result v4

    invoke-static {v9, v3, v4, v14}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->canBeUsedInPath(IIZI)Z
    ...
    invoke-virtual {v8, v13, v14, v3, v14}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->setPath(IILjava/util/List;I)V
    ...
    invoke-virtual {v8, v13, v14, v2, v14}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->setPath(IILjava/util/List;I)V
    ...
    :try_start_317
    invoke-virtual/range {v1 .. v7}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->buildPath(ILjava/util/List;Ljava/util/List;Ljava/util/List;II)Z

    move-result v0
    :try_end_31b
    .catch Ljava/lang/StackOverflowError; {:try_start_317 .. :try_end_31b} :catch_31c
...
.method public buildPath2(ILjava/util/List;Ljava/util/List;IIZZLjava/util/List;Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-static {v13, v10}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->isFriendlyProvince(II)Z

    move-result v4

    invoke-static {v13, v3, v4, v10}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->canBeUsedInPath(IIZI)Z
    ...
    invoke-virtual {v12, v11, v10, v3, v10}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->setPath(IILjava/util/List;I)V
    ...
    move-result v1
    :try_end_491
    .catch Ljava/lang/Exception; {:try_start_14 .. :try_end_491} :catch_4bb
    ...
    :try_start_4ae
    invoke-virtual/range {v1 .. v11}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->buildPath2(ILjava/util/List;Ljava/util/List;IIZZLjava/util/List;Ljava/util/List;Ljava/util/List;)Z

    move-result v0
    :try_end_4b2
    .catch Ljava/lang/StackOverflowError; {:try_start_4ae .. :try_end_4b2} :catch_4b7
    .catch Ljava/lang/Exception; {:try_start_4ae .. :try_end_4b2} :catch_4b3
...
.method public buildRoute(III)Z
    ...
    .line 47
    iput v13, v11, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->fromProvinceID:I
    ...
    invoke-static {v12, v14}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->isFriendlyProvince(II)Z

    move-result v2

    invoke-static {v12, v1, v2, v14}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->canBeUsedInPath(IIZI)Z
    ...
    invoke-virtual {v11, v13, v14, v1, v14}, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->setPath(IILjava/util/List;I)V
...
.method public final setPath(IILjava/util/List;I)V
    ...
    .line 357
    iget-object v1, p0, Lage/of/civilizations2/jakowski/lukasz/RegroupArmy/RegroupArmy;->route:Ljava/util/List;

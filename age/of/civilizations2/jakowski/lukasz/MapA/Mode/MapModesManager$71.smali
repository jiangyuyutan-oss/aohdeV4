.class Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapModesManager$71;
...
.method constructor <init>(Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapModesManager;)V
    ...
    .line 3917
    iput-object p1, p0, Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapModesManager$71;->this$0:Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapModesManager;
...
.method public canMoveArmy()Z
    ...
    .line 3920
    invoke-super {p0}, Lage/of/civilizations2/jakowski/lukasz/MapA/Mode/MapMode;->canMoveArmy()Z
...
.method public getProvinceInformation()Lage/of/civilizations2/jakowski/lukasz/MenuE_HoverP/ME_Hover;
    ...
    move-result v4
    :try_end_17
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_17} :catch_273
    ...
    :try_end_272
    .catch Ljava/lang/Exception; {:try_start_1c .. :try_end_272} :catch_273
...
.method public updateActiveProvinceID_ExtraAction(II)V
    ...
    .line 4023
    .local v1, "newCivID":I
    sget-boolean v2, Lage/of/civilizations2/jakowski/lukasz/Menus/Turn/Menu_NextPlayerTurn;->lockExtraAction:Z

    const/4 v3, 0x1

    if-nez v2, :cond_d9

    sget-boolean v2, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->buildBySelectingProvinceOnMap:Z
    ...
    invoke-static {p2, v2}, Lage/of/civilizations2/jakowski/lukasz/GameManager;->invest_MaxEconomy_Gold(II)I
    ...
    invoke-static {p2, v5, v2}, Lage/of/civilizations2/jakowski/lukasz/GameManager;->invest(III)Z
    ...
    iput-boolean v3, v5, Lage/of/civilizations2/jakowski/lukasz/Province;->viewBool:Z
    ...
    invoke-virtual {v5, v3}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->setVisible_InGame_ViewEconomy(Z)V

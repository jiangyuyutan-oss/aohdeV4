...
.method public draw(Lcom/badlogic/gdx/graphics/g2d/SpriteBatch;II)V
    ...
    :goto_38
    iget-object v2, p0, Lage/of/civilizations2/jakowski/lukasz/Z_Other/TutorialManager$98;->this$0:Lage/of/civilizations2/jakowski/lukasz/Z_Other/TutorialManager;
    ...
    invoke-virtual {v0, p1, v1, v2, v3}, Lage/of/civilizations2/jakowski/lukasz/Z_Other/TutorialManager;->drawLine(Lcom/badlogic/gdx/graphics/g2d/SpriteBatch;III)V
    ...
    invoke-virtual {v3}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->getInGame_Civ_Info_Diplomacy()Lage/of/civilizations2/jakowski/lukasz/Menu;

    move-result-object v3

    invoke-virtual {v3}, Lage/of/civilizations2/jakowski/lukasz/Menu;->getHeightM()I

    move-result v3

    invoke-virtual {v0, p1, v1, v2, v3}, Lage/of/civilizations2/jakowski/lukasz/Z_Other/TutorialManager;->drawLineVertical(Lcom/badlogic/gdx/graphics/g2d/SpriteBatch;III)V
    ...
    invoke-virtual {v3}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->getInGame_Civ_Info()Lage/of/civilizations2/jakowski/lukasz/Menu;
    ...
    invoke-virtual {v3}, Lage/of/civilizations2/jakowski/lukasz/MenuManager;->getInGame_Civ_Info_Actions()Lage/of/civilizations2/jakowski/lukasz/Menu;
    ...
    :try_end_179
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_8 .. :try_end_179} :catch_17c
    .catch Ljava/lang/NullPointerException; {:try_start_8 .. :try_end_179} :catch_17a

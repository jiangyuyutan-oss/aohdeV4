.class public Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;
.super Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build;
.source "AI_Build_Workshop.java"
...
.method public constructor <init>(IJ)V
    ...
    iput-object v0, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->lBuildCost:Ljava/util/List;
    ...
    .line 24
    iget-object v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->lBuildCost:Ljava/util/List;
    ...
    invoke-static {v3, v2}, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->getWorkshop_BuildCost(II)I
    ...
    .line 25
    iget-object v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->lProvincesToBuild:Ljava/util/List;
    ...
    .end local v0  # "i":I
    :cond_38
    iget-object v0, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->lBuildCost:Ljava/util/List;
    ...
    invoke-static {v1}, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->canBuildWorkshop(I)Z
    ...
    sget-object v3, Lage/of/civilizations2/jakowski/lukasz/Civilizations/Construction/ConstructionType;->WORKSHOP:Lage/of/civilizations2/jakowski/lukasz/Civilizations/Construction/ConstructionType;
    ...
    .line 41
    iget v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->iProvincesToBuild_NumOfElements:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->iProvincesToBuild_NumOfElements:I

    .line 43
    iget v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->iMaxDangerLevel:I
    ...
    iput v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->iMaxDangerLevel:I
    :try_end_140
...
.method public build(IIZ)Z
    ...
    iget-object v2, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->lProvincesToBuild:Ljava/util/List;
    ...
    .line 69
    iget-object v4, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->lProvincesToBuild:Ljava/util/List;
    ...
    .line 71
    iget-object v5, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->lProvincesToBuild:Ljava/util/List;
    ...
    .line 72
    invoke-virtual {p0, p1, v0}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->getProvinceBuildScore(II)F
    ...
    invoke-virtual {p0, p1, v5}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->getProvinceBuildScore(II)F
    ...
    .line 85
    invoke-static {v0, p1}, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->constructWorkshop(II)Z
    ...
    .line 88
    invoke-virtual {p0, p1}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->getMoney(I)J

    move-result-wide v4

    iget-object v2, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->lBuildCost:Ljava/util/List;
    ...
    .line 93
    iget-object v6, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->lProvincesToBuild:Ljava/util/List;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->build(IIZ)Z
...
.method public getNumOfAlreadyBuilt(I)I
    ...
    iget v0, v0, Lage/of/civilizations2/jakowski/lukasz/Civilization;->numOf_Workshops:I
...
.method public getProvinceBuildScore(II)F
    ...
    iget v1, v1, Lage/of/civilizations2/jakowski/lukasz/CivPersonality;->BUILD_WORKSHOP_POP_SCORE:F
    ...
    iget v2, v2, Lage/of/civilizations2/jakowski/lukasz/CivPersonality;->BUILD_WORKSHOP_ECO_SCORE:F
    ...
    iget v3, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Workshop;->iMaxDangerLevel:I

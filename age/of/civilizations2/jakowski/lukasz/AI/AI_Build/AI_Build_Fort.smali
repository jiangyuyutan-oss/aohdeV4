.class public Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;
.super Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build;
.source "AI_Build_Fort.java"
...
.method public constructor <init>(IJ)V
    ...
    iput-object v0, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->lBuildCost:Ljava/util/List;
    ...
    .line 24
    iget-object v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->lBuildCost:Ljava/util/List;
    ...
    invoke-static {v3, v2}, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->getFort_BuildCost(II)I
    ...
    .line 25
    iget-object v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->lProvincesToBuild:Ljava/util/List;
    ...
    .end local v0  # "i":I
    :cond_38
    invoke-virtual {p0, p1}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->getMoney(I)J

    move-result-wide v0

    iget-object v3, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->lBuildCost:Ljava/util/List;
    ...
    invoke-static {v1}, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->canBuildFort(I)Z
    ...
    sget-object v3, Lage/of/civilizations2/jakowski/lukasz/Civilizations/Construction/ConstructionType;->FORT:Lage/of/civilizations2/jakowski/lukasz/Civilizations/Construction/ConstructionType;
    ...
    move-result v1
    :try_end_ce
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_b .. :try_end_ce} :catch_14b
    ...
    .line 40
    iget v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->iProvincesToBuild_NumOfElements:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->iProvincesToBuild_NumOfElements:I

    .line 42
    iget v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->iMaxDangerLevel:I
    ...
    iput v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->iMaxDangerLevel:I
    :try_end_144
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_d0 .. :try_end_144} :catch_145
...
.method public build(IIZ)Z
    ...
    iget-object v2, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->lProvincesToBuild:Ljava/util/List;
    ...
    .line 68
    iget-object v3, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->lProvincesToBuild:Ljava/util/List;
    ...
    .line 70
    iget-object v4, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->lProvincesToBuild:Ljava/util/List;
    ...
    .line 71
    invoke-virtual {p0, p1, v0}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->getProvinceBuildScore(II)F
    ...
    invoke-virtual {p0, p1, v4}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->getProvinceBuildScore(II)F
    ...
    .line 84
    invoke-static {v0, p1}, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->constructFort(II)Z
...
.method public getProvinceBuildScore(II)F
    ...
    iget v3, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Fort;->iMaxDangerLevel:I

.class public Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;
.super Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build;
.source "AI_Build_Library.java"


# instance fields
.field public lBuildCost:Ljava/util/List;
...
.method public constructor <init>(IJ)V
    ...
    iput-object v0, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->lBuildCost:Ljava/util/List;
    ...
    .line 24
    iget-object v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->lBuildCost:Ljava/util/List;
    ...
    invoke-static {v3, v2}, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->getLibrary_BuildCost(II)I
    ...
    .line 25
    iget-object v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->lProvincesToBuild:Ljava/util/List;
    ...
    .end local v0  # "i":I
    :cond_38
    iget-object v0, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->lBuildCost:Ljava/util/List;
    ...
    invoke-static {v1}, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->canBuildLibrary(I)Z
    ...
    sget-object v3, Lage/of/civilizations2/jakowski/lukasz/Civilizations/Construction/ConstructionType;->LIBRARY:Lage/of/civilizations2/jakowski/lukasz/Civilizations/Construction/ConstructionType;
    ...
    move-result v1
    :try_end_ca
    .catch Ljava/lang/Exception; {:try_start_b .. :try_end_ca} :catch_14a
    ...
    .line 40
    iget v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->iProvincesToBuild_NumOfElements:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->iProvincesToBuild_NumOfElements:I

    .line 42
    iget v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->iMaxDangerLevel:I
    ...
    iput v1, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->iMaxDangerLevel:I
    :try_end_140
    .catch Ljava/lang/Exception; {:try_start_cc .. :try_end_140} :catch_141
    ...
    :try_end_145
    .catch Ljava/lang/Exception; {:try_start_142 .. :try_end_145} :catch_14a
...
.method public build(IIZ)Z
    ...
    iget-object v2, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->lProvincesToBuild:Ljava/util/List;
    ...
    .line 68
    iget-object v4, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->lProvincesToBuild:Ljava/util/List;
    ...
    .line 70
    iget-object v5, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->lProvincesToBuild:Ljava/util/List;
    ...
    .line 71
    invoke-virtual {p0, p1, v0}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->getProvinceBuildScore(II)F
    ...
    invoke-virtual {p0, p1, v5}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->getProvinceBuildScore(II)F
    ...
    .line 83
    invoke-static {v0, p1}, Lage/of/civilizations2/jakowski/lukasz/MapA/BuildingsManager;->constructLibrary(II)Z
    ...
    .line 86
    invoke-virtual {p0, p1}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->getMoney(I)J

    move-result-wide v4

    iget-object v2, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->lBuildCost:Ljava/util/List;
    ...
    .line 91
    iget-object v6, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->lProvincesToBuild:Ljava/util/List;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->build(IIZ)Z
...
.method public getProvinceBuildScore(II)F
    ...
    iget v3, p0, Lage/of/civilizations2/jakowski/lukasz/AI/AI_Build/AI_Build_Library;->iMaxDangerLevel:I

...
.method protected loadModelData(Lcom/badlogic/gdx/files/FileHandle;Z)Lcom/badlogic/gdx/graphics/g3d/model/data/ModelData;
    ...
    :try_end_37
    .catch Ljava/io/IOException; {:try_start_33 .. :try_end_37} :catch_4e9
    ...
    if-le v13, v12, :cond_12a

    .line 148
    const/4 v13, 0x1

    if-ne v10, v13, :cond_119
    ...
    if-eq v15, v7, :cond_236

    const/16 v7, 0x67

    if-ne v15, v7, :cond_1fa
    ...
    move-result-object v7
    :try_end_247
    .catch Ljava/io/IOException; {:try_start_3e .. :try_end_247} :catch_24a
    ...
    :try_end_254
    .catch Ljava/io/IOException; {:try_start_251 .. :try_end_254} :catch_4e9

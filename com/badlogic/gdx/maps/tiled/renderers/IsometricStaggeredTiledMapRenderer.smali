...
.method public renderTileLayer(Lcom/badlogic/gdx/maps/tiled/TiledMapTileLayer;)V
    ...
    .line 139
    packed-switch v25, :pswitch_data_2f6
    ...
    .line 155
    .end local v2  # "tempU":F
    .end local v45  # "tempV":F
    :pswitch_21f  #0x2
    iget-object v1, v0, Lcom/badlogic/gdx/maps/tiled/renderers/IsometricStaggeredTiledMapRenderer;->vertices:[F
    ...
    .end local v4  # "x1":F
    .local v35, "x1":F
    invoke-interface {v1, v2, v8, v4, v0}, Lcom/badlogic/gdx/graphics/g2d/Batch;->draw(Lcom/badlogic/gdx/graphics/Texture;[FII)V
    ...
    .end local v32  # "u2":F
    .end local v33  # "v2":F
    .end local v34  # "layerTileHeight":F
    .end local v35  # "x1":F
    .end local v43  # "y1":F
    .end local v44  # "color":F
    .local v1, "offsetX":F
    ...
    .restart local v34  # "layerTileHeight":F
    .restart local v44  # "color":F
    :goto_2c5

...
.method public renderTileLayer(Lcom/badlogic/gdx/maps/tiled/TiledMapTileLayer;)V
    ...
    .line 110
    .local v26, "region":Lcom/badlogic/gdx/graphics/g2d/TextureRegion;
    invoke-interface/range {v22 .. v22}, Lcom/badlogic/gdx/maps/tiled/TiledMapTile;->getOffsetX()F

    move-result v27

    iget v4, v0, Lcom/badlogic/gdx/maps/tiled/renderers/OrthogonalTiledMapRenderer;->unitScale:F

    mul-float v27, v27, v4

    add-float v27, v18, v27
    ...
    .line 112
    .local v4, "y1":F
    invoke-virtual/range {v26 .. v26}, Lcom/badlogic/gdx/graphics/g2d/TextureRegion;->getRegionWidth()I
    ...
    .line 113
    .local v7, "x2":F
    invoke-virtual/range {v26 .. v26}, Lcom/badlogic/gdx/graphics/g2d/TextureRegion;->getRegionHeight()I
    ...
    .line 115
    .local v8, "y2":F
    invoke-virtual/range {v26 .. v26}, Lcom/badlogic/gdx/graphics/g2d/TextureRegion;->getU()F

    move-result v9

    .line 116
    .local v9, "u1":F
    invoke-virtual/range {v26 .. v26}, Lcom/badlogic/gdx/graphics/g2d/TextureRegion;->getV2()F

    move-result v31

    .line 117
    .local v31, "v1":F
    invoke-virtual/range {v26 .. v26}, Lcom/badlogic/gdx/graphics/g2d/TextureRegion;->getU2()F

    move-result v32

    .line 118
    .local v32, "u2":F
    invoke-virtual/range {v26 .. v26}, Lcom/badlogic/gdx/graphics/g2d/TextureRegion;->getV()F
    ...
    .line 161
    packed-switch v25, :pswitch_data_222
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/badlogic/gdx/graphics/g2d/TextureRegion;->getTexture()Lcom/badlogic/gdx/graphics/Texture;
    ...
    .end local v7  # "x2":F
    .local v36, "x2":F
    invoke-interface {v2, v0, v10, v7, v4}, Lcom/badlogic/gdx/graphics/g2d/Batch;->draw(Lcom/badlogic/gdx/graphics/Texture;[FII)V
    ...
    .end local v25  # "rotations":I
    .end local v26  # "region":Lcom/badlogic/gdx/graphics/g2d/TextureRegion;
    .end local v27  # "x1":F
    .end local v28  # "layerOffsetX":F
    .end local v29  # "layerOffsetY":F
    .end local v30  # "col1":I
    .end local v31  # "v1":F
    .end local v32  # "u2":F
    .end local v33  # "v2":F

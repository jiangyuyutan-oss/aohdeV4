...
.method public parse([CII)Lcom/badlogic/gdx/utils/XmlReader$Element;
    ...
    :cond_1d
    :pswitch_1d  #0x1
    sget-object v10, Lcom/badlogic/gdx/utils/XmlReader;->_xml_key_offsets:[B

    aget-byte v10, v10, v7

    .line 124
    .local v10, "_keys":I
    sget-object v11, Lcom/badlogic/gdx/utils/XmlReader;->_xml_index_offsets:[S

    aget-short v8, v11, v7

    .line 125
    sget-object v11, Lcom/badlogic/gdx/utils/XmlReader;->_xml_single_lengths:[B
    ...
    sget-object v16, Lcom/badlogic/gdx/utils/XmlReader;->_xml_trans_keys:[C

    move/from16 v17, v4

    .end local v4  # "s":I
    .restart local v17  # "s":I
    aget-char v4, v16, v14

    if-ge v15, v4, :cond_4b
    ...
    sget-object v15, Lcom/badlogic/gdx/utils/XmlReader;->_xml_trans_keys:[C

    aget-char v15, v15, v14

    if-le v4, v15, :cond_58
    ...
    .line 169
    .end local v4  # "_lower":I
    .end local v12  # "_upper":I
    .end local v13  # "_mid":I
    :cond_93
    :goto_93
    ...
    .line 174
    .local v7, "_acts":I
    sget-object v12, Lcom/badlogic/gdx/utils/XmlReader;->_xml_actions:[B
    ...
    packed-switch v12, :pswitch_data_31c
    ...
    sparse-switch v13, :sswitch_data_330
    ...
    .line 280
    .local v16, "entityFound":Z
    :goto_d4
    if-eq v13, v12, :cond_12d
    ...
    .end local v4  # "cs":I
    .restart local v18  # "cs":I
    const/16 v4, 0x26

    if-eq v13, v4, :cond_e5
    ...
    .end local v13  # "current":I
    .restart local v17  # "current":I
    aget-char v13, v1, v13

    move/from16 v19, v8

    .end local v8  # "_trans":I
    .restart local v19  # "_trans":I
    const/16 v8, 0x3b
    ...
    invoke-virtual {v8, v1, v5, v13}, Lcom/badlogic/gdx/utils/StringBuilder;->append([CII)Lcom/badlogic/gdx/utils/StringBuilder;
    ...
    invoke-direct {v8, v1, v4, v13}, Ljava/lang/String;-><init>([CII)V
    ...
    .end local v17  # "current":I
    .end local v19  # "_trans":I
    .end local v20  # "entityStart":I
    .end local v21  # "name":Ljava/lang/String;
    .local v4, "entityStart":I
    .local v8, "_trans":I
    .local v13, "current":I
    .restart local v16  # "entityFound":Z
    :cond_124
    move/from16 v20, v4
    ...
    invoke-virtual {v4, v1, v5, v8}, Lcom/badlogic/gdx/utils/StringBuilder;->append([CII)Lcom/badlogic/gdx/utils/StringBuilder;
    ...
    invoke-virtual {v4, v8}, Lcom/badlogic/gdx/utils/StringBuilder;->setLength(I)V
    ...
    invoke-direct {v8, v1, v5, v12}, Ljava/lang/String;-><init>([CII)V
    ...
    invoke-direct {v5, v1, v8, v12}, Ljava/lang/String;-><init>([CII)V
    ...
    .packed-switch 0x0
        :pswitch_15  #00000000
        :pswitch_1d  #00000001
        :pswitch_28e  #00000002
    .end packed-switch

    :pswitch_data_31c
    .packed-switch 0x0
        :pswitch_26e  #00000000

...
.method static constructor <clinit>()V
    ...
    .line 42
    .end local v0  # "kFastSlots":I
    .end local v1  # "c":I
    .end local v2  # "slotFast":I
    :cond_2b
    return-void
.end method
...
.method Backward(I)I
    ...
    iput v4, v2, Lcom/badlogic/gdx/utils/compression/lzma/Encoder$Optimal;->BackPrev:I
    ...
    .line 483
    iget v2, p0, Lcom/badlogic/gdx/utils/compression/lzma/Encoder;->_optimumCurrentIndex:I
...
.method public CodeOneBlock([J[J[Z)V
    ...
    iget-object v6, v0, Lcom/badlogic/gdx/utils/compression/lzma/Encoder;->_inStream:Ljava/io/InputStream;

    invoke-virtual {v5, v6}, Lcom/badlogic/gdx/utils/compression/lz/BinTree;->SetStream(Ljava/io/InputStream;)V
...
.method Create()V
    ...
    invoke-virtual {v0, v1, v4, v2, v3}, Lcom/badlogic/gdx/utils/compression/lz/BinTree;->Create(IIII)Z
...
.method GetOptimum(I)I
    ...
    invoke-virtual {v13, v7, v14, v9}, Lcom/badlogic/gdx/utils/compression/lz/BinTree;->GetMatchLen(III)I
    ...
    if-lt v9, v13, :cond_90

    .line 523
    iput v10, v0, Lcom/badlogic/gdx/utils/compression/lzma/Encoder;->backRes:I

    .line 524
    iget-object v2, v0, Lcom/badlogic/gdx/utils/compression/lzma/Encoder;->repLens:[I
...
.method public SetLcLpPb(III)Z
    ...
    .line 1232
    iget v0, p0, Lcom/badlogic/gdx/utils/compression/lzma/Encoder;->_posStateBits:I
    ...
    iput v0, p0, Lcom/badlogic/gdx/utils/compression/lzma/Encoder;->_posStateMask:I
